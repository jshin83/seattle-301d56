...
function displayPics(){
  ...
  /* Because the const variable is in a block within a while loop, it cannot be accessed outside of that loop.
  The console log was outside of that block, therefore the scope was out of reach.
  */
