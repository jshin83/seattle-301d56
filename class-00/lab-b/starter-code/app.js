...
// The arrow function does not bind to the object (so it essentially doesn't know what 'this' is referring to)
// so the context bubbles up to the window object, which is the next enclosing scope.
